...
-- This migration updates all product names and image paths to follow consistent naming conventions
-- Product names: "[Brand] [Flavor] ([Strength]mg)"
-- Image paths: kebab-case with "brand-flavor-strength" format

BEGIN;

-- Update product names and image paths to follow consistent conventions
UPDATE products
SET 
    name = CASE 
        -- PUXX Strong (22mg) products
    ...
    image_url = CASE 
        ...
        -- Apple Mint products - keep existing paths if they follow conventions
...
-- Fix any typos or inconsistencies in the description field
UPDATE products
SET 
    description = CASE
...
-- Add a comment explaining the standardized naming convention for future reference
