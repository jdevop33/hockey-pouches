    ...
    <div className="mt-8 rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
      ...
      <div className="flex flex-wrap gap-2">
        <a
          ...
          className="flex items-center rounded-full bg-[#1DA1F2] px-4 py-2 text-sm font-medium text-white transition-transform hover:scale-105"
        >
          <svg
        ...
        <button
          ...
          className="relative flex items-center rounded-full bg-primary-600 px-4 py-2 text-sm font-medium text-white transition-transform hover:scale-105"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="mr-2 h-4 w-4"
