...
const DashboardLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const baseNavItems: NavItem[] = [
    ...
    {
      label: 'Referrals & Commissions', // Renamed for clarity for all users
      href: '/dashboard/referrals', // Assuming this is the main page
      icon: (
  ...
  const roleNavItems: { [key: string]: NavItem[] } = {
    Distributor: [
      ...
      {
        label: 'Inventory',
        href: '/distributor/dashboard/inventory', // Added Inventory Link
        icon: (
      ...
      {
        label: 'Tasks',
        href: '/dashboard/tasks', // Assuming tasks are relevant
        icon: (
    ...
    // Default/Customer role items are handled by baseNavItems
  };
  ...
  // Filter out duplicates (if any, though unlikely with this structure)
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex items-center justify-between border-b bg-white p-4 md:hidden">
        ...
        {/* TODO: Implement mobile sidebar/menu toggle functionality */}
      </div>
