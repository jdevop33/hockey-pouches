...
const FormFeedback: React.FC<FormFeedbackProps> = ({ type, message, className = '' }) => {
  ...
  return (
    <div className={`rounded-md border p-4 ${typeClasses} ${className}`} role="alert">
      <div className="flex">
        <div className="flex-shrink-0">{iconByType}</div>
        <div className="ml-3">
