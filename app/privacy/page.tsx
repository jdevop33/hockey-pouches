  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-lg max-w-none">
        <p>
          At PUXX, we take your privacy seriously. This Privacy Policy explains how we collect, use,
        ...
        <p>
          ...
          our website, express interest in obtaining information about us or our products, or
        ...
        <p>
          Our website and services are not intended for individuals under the age of 21. We do not
          knowingly collect personal information from children under 21. If we learn we have
          collected personal information from a child under 21, we will delete that information.
        </p>
        ...
        <p className="mt-8">Last updated: June 1, 2023</p>
